...
module.exports = {
  ...
  mailgun: {
    user: process.env.MAILGUN_SMTP_LOGIN || 'postmaster@sandbox697fcddc09814c6b83718b9fd5d4e5dc.mailgun.org',
    password: process.env.MAILGUN_SMTP_PASSWORD || '29eldds1uri6',
